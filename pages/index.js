        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-5xl mx-auto px-4 md:px-6">
            <div className="text-center mb-6 md:mb-10">
              <h2 className={`text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 ${playfair.className}`}>
                Hear From Our Happy Clients
              </h2>
              <p className={`text-base text-gray-600 max-w-xl mx-auto ${inter.className}`}>
                Real stories from homeowners who trusted us with their villa transformations
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto">
              {[
                { src: "/testimonial-1.mp4", name: "Client Testimonial 1" },
                { src: "/testimonial-2.mp4", name: "Client Testimonial 2" },
                { src: "/testimonial-3.mp4", name: "Client Testimonial 3" }
              ].map((video, index) => (
                <div key={index} className="relative group">
                  <div className="bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div className="relative aspect-[9/14]">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
                        <div className="w-12 h-12 bg-amber-600/90 rounded-full flex items-center justify-center">
                    ...
                    {/* Video Label */}
                    <div className="p-3 bg-gradient-to-t from-gray-900 to-transparent absolute bottom-0 left-0 right-0">
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className={`text-white font-semibold text-xs ${inter.className}`}>Satisfied Customer</p>
                          <p className={`text-gray-300 text-xs ${inter.className}`}>Villa Renovation</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center gap-2 bg-amber-50 px-4 py-2 rounded-full border border-amber-200">
                ...
                <span className={`text-amber-800 font-semibold text-sm ${inter.className}`}>100% Real Customer Testimonials</span>
              </div>
            </div>
          </div>
        </section>
