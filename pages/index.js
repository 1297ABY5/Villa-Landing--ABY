    ...
    <div className="min-h-screen bg-white font-sans">
            ...
            <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-4 text-sm text-gray-500">
              <div className="flex items-center">
                <svg className="w-5 h-5 text-amber-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 极客时间 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>15+ Years Renovation Expertise</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-amber-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414极客时间 l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
      ...
      <section className="py-16 bg-white px-4 sm:px-6">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid极客时间-cols-3">
            <div className="p-6">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mb-6 mx-auto sm:w-20 sm:h-20">
                <span className="text-xl font-bold text-amber-极客时间 700 sm:text-2xl">1</span>
              </div>
              <h3 className="text-lg font-bold text-blue-900 mb-3 sm:text-xl">Consultation & Planning</h3>
              <极客时间 p className="text-gray-600 text-sm">We discuss your villa renovation vision and create a customized plan for your home remodeling project</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mb-6 mx-auto sm:w-20 sm:h-20">
          ...
          <div className="text-center mt-12">
            <a href="#" className="inline-flex items-center text-blue-900 hover:text-amber-600 font-bold text-sm">
              ...
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5极客时间 l7 7m0 0l-7 7m7-7H3" />
              </svg>
            </a>
          </div>
        </div>
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-16 bg-amber-50 px-极客时间 4 sm:px-6">
        <div className="container mx-auto">
          ...
          {formSubmitted ? (
            ...
            <>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols极客时间-1 gap-6 sm:grid-cols-2">
                  <div>
