...
export default function Home() {
  ...
  const features = [
    {
      ...
      desc: "Fully compliant with local laws & building codes.",
      icon: "🏛️",
    },
    {
      title: "15+ Years of Excellence",
      desc: "Trusted by Dubai’s most prestigious communities.",
      icon: "🌟",
    },
    {
      title: "3D Luxury Visualization",
      desc: "Photorealistic previews before execution.",
      icon: "🏠",
    },
  ];
  ...
  const portfolioItems = [
    {
      img: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?auto=format&fit=crop&w=1087&q=80",
      title: "Emirates Hills Villa",
      desc: "Ultra-modern transformation",
    },
    {
      img: "https://images.unsplash.com/photo-1616137422495-1e9e46e2aa77?auto=format&fit=crop&w=1170&q=80",
      title: "Palm Jumeirah Spa",
      desc: "Resort-style bathroom",
    },
    {
      img: "https://images.unsplash.com/photo-1600566753052-d7f4e46f5d20?auto=format&fit=crop&w=1170&q=80",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-amber-50">
      <Head>
        ...
        <meta
          name="description"
          content="Dubai’s premium villa renovation specialists. 3D designs, certified quality, and 15+ years of luxury experience."
        />
      </Head>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            <h1 className="text-5xl font-extrabold text-blue-900 leading-tight mb-6">
              Redefine Your Villa with{" "}
              <span className="text-amber-600">Luxury Renovations</span>
            </h1>
            <p className="text-lg text-gray-700 mb-6">
              From Palm Jumeirah to Emirates Hills, we create homes that exude
              prestige, sophistication, and timeless design.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#portfolio"
                className="border-2 border-blue-900 text-blue-900 hover:bg-blue-900 hover:text-white font-bold py-3 px-8 rounded-full transition"
              >
                View Portfolio
              </a>
            </div>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <div
                key={i}
                className="bg-amber-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition transform hover:-translate-y-2"
              >
      ...
      <section
        id="contact"
        className="py-20 bg-gradient-to-b from-blue-900 to-blue-800 text-white px-6"
      >
        <div className="container mx-auto max-w-3xl bg-white text-gray-800 rounded-2xl shadow-2xl p-10">
          ...
          <form className="space-y-6">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border rounded-lg"
            ></textarea>
            <button className="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-4 rounded-lg shadow-lg transition">
              Submit Request
            </button>
          </form>
        </div>
