...
export default function Home() {
  ...
  // Data arrays (I've kept your original data structures)
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
              <div className="p-6">
                ...
                <p className="text-gray-500 mt-2 text-sm">Perfecting luxury <strong>villa renovation services</strong> and <strong>home remodeling</strong> across Dubai.</p>
              </div>
              <div className="p-6">
              ...
              <div className="space-y-16">
                ...
                <div className="flex md:items-center flex-col md:flex-row">
                  <div className="md:w-1/2 md:pr-16 text-center md:text-right">
                    <div className="text-5xl font-extrabold font-heading text-brand-gold mb-2">01</div>
                    <h3 className="text-xl font-bold font-heading text-brand-dark mb-3">Consultation & Planning</h3>
                    <p className="text-gray-600">We discuss your <strong>villa renovation</strong> vision and create a customized plan for your <strong>home remodeling</strong> project.</p>
                  </div>
                ...
                <div className="flex md:items-center flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 md:pl-16 text-center md:text-left">
                    <div className="text-5xl font-extrabold font-heading text-brand-gold mb-2">02</div>
                    <h3 className="text-xl font-bold font-heading text-brand-dark mb-3">Design Development</h3>
                    <p className="text-gray-600">Our <strong>interior design</strong> team creates detailed plans and 3D renders for your <strong>villa transformation</strong>.</p>
                  </div>
                </div>
                {/* Step 3 */}
                <div className="flex md:items-center flex-col md:flex-row">
                  <div className="md:w-1/2 md:pr-16 text-center md:text-right">
                    <div className="text-5xl font-extrabold font-heading text-brand-gold mb-2">03</div>
                    <h3 className="text-xl font-bold font-heading text-brand-dark mb-3">Exquisite Execution</h3>
                    <p className="text-gray-600">Our <strong>renovation contractors</strong> bring your <strong>villa renovation</strong> to life with precision craftsmanship.</p>
                  </div>
                  <div className="md:w-1/2 md:pl-16"></div>
                </div>
                {/* Step 4 */}
                <div className="flex md:items-center flex-col md:flex-row">
                  <div className="md:w-1/2 md:pr-16"></div>
                  <div className="md:w-1/2 md:pl-16 text-center md:text-left">
                    <div className="text-5xl font-extrabold font-heading text-brand-gold mb-2">04</div>
                    <h3 className="text-xl font-bold font-heading text-brand-dark mb-3">Final Reveal</h3>
                    <p className="text-gray-600">We present your transformed <strong>villa renovation</strong>, ensuring every detail exceeds expectations.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {testimonials.map((t, index) => (
                <div key={index} className="bg-brand-light p-8 rounded-2xl border border-gray-100 relative">
                  <span className="absolute top-4 left-6 text-8xl text-brand-gold font-heading opacity-10">“</span>
